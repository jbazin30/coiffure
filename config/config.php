...
define('PHP_EXTENSION_MBSTRING', (extension_loaded('mbstring')) ? TRUE : FALSE); // défini si l'extension MBSTRING est chargée sur le serveur

define('LANG_DEFAULT', 'fr'); // langue par défaut

define('C_NOTICE', E_USER_NOTICE); // défini un type d'erreur personnalisé pour les "user_notice"
define('C_ERROR', E_USER_ERROR); // défini un type d'erreur personnalisé pour les "user_error"

define('DIR_MPIC', 'templates/images/'); // défini le dossier des miniatures
